...
| フォルダ | テーマ | 対応記事 |
|---|---|---|
| [`meta-evaluation`](./meta-evaluation) | LLMジャッジのメタ評価。人間ラベルとの一致度 (Cohen's kappa) でジャッジの信頼性を定量化する | [ジャッジを評価するジャッジ ― LLM\-as\-a\-Judgeの信頼性をメタ評価で保証する \#生成AI \- Qiita](https://qiita.com/taka_yayoi/items/65be4c75b65a6b7363e3) |
